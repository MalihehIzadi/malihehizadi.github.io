...
<!-- {% bibliography --group_by none --query @*[keywords~=thesis and keywords~=mizadi]* --template author_publication %} -->
<!-- {% bibliography --group_by none --query @*[keywords~=/(thesis.*mizadi|mizadi.*thesis)/]* --template author_publication %} -->