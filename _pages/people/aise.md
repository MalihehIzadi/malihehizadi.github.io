...
**Intelligent systems for software development with large language models**: Exploring how LLMs can support and transform key aspects of software development workflows across diverse contexts and coding tasks, including code generation, summarization, refactoring, and bug fixing.

**Trust, transparency, and model behavior**: Addressing challenges of explainability, hallucination, memorization, & aligned behavior in LLM-based systems integrated into developer-facing tools.
